...
import argparse
from LStm_class import LstmModel
...
def main(arguments):
    ...
    if arguments.operation == 'train':
        ...
        # slice the validation dataset to be exact as per the batch size
        ...
        model = LstmModel(lr=LEARNING_RATE, batch_size=BATCH_SIZE, cell_size=CELL_SIZE, dropout_rate=DROPOUT_P_KEEP,
